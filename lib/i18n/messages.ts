...
const en = {
  ...
  "menu.deviceOnly": "Your airdrops are saved on this device.",
  "menu.signInSupporter": "Sign in to save your airdrops",
  "menu.moderatorSignIn": "Moderator sign-in",
  "menu.reviewQueue": "Review queue",
  "menu.boardConsole": "Board console",
  ...
  "contribute.receiverCode": "Recipient name — use this code",
  "contribute.codeHint":
    "Set the delivery recipient's NAME to this code so a volunteer can match your parcel at the drop point.",
  "contribute.yourCode": "Your parcel code: {code}",
  "contribute.fieldDropPoint": "Drop point",
  "contribute.fieldAddress": "Address",
  "contribute.fieldRecipient": "Site contact",
  ...
  "contribute.step1": "Copy the address and the code",
  "contribute.step2": "Order it — set the recipient name to the code",
...
const hi: Record<MessageKey, string> = {
  ...
  "menu.light": "लाइट",
  "menu.language": "भाषा",
  "menu.deviceOnly": "आपके एयरड्रॉप इसी डिवाइस पर सहेजे गए हैं।",
  "menu.signInSupporter": "अपने एयरड्रॉप सहेजने के लिए साइन इन करें",
  "menu.moderatorSignIn": "मॉडरेटर साइन-इन",
  "menu.reviewQueue": "समीक्षा सूची",
  "menu.boardConsole": "बोर्ड कंसोल",
  ...
  "contribute.receiverCode": "पाने वाले का नाम — यह कोड इस्तेमाल करें",
  "contribute.codeHint":
    "डिलीवरी में पाने वाले का नाम यह कोड रखें, ताकि वॉलंटियर ड्रॉप पॉइंट पर आपका पार्सल पहचान सके।",
  "contribute.yourCode": "आपका पार्सल कोड: {code}",
  "contribute.fieldDropPoint": "ड्रॉप पॉइंट",
  "contribute.fieldAddress": "पता",
  "contribute.fieldRecipient": "साइट संपर्क",
  ...
  "contribute.step1": "पता और कोड कॉपी करें",
  "contribute.step2": "ऑर्डर करें — पाने वाले का नाम कोड रखें",
